...
> Google Trends 검색 관심도를 STL 시계열 분해로 분석해, 패션 아이템 30개를 메가 · 마이크로 · 스테디 트렌드로 분류하고 각 아이템의 수명주기 단계(도입·성장·정점·쇠퇴)와 분류·단계별 실무 전략을 도출한 데이터 분석 프로젝트.

**🔗 결과 웹페이지:** [https://yeonjung77.github.io/stl/](https://yeonjung77.github.io/stl/)
